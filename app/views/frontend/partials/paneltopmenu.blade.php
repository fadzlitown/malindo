    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="javascript:void(0);">Welcome, <span class="displayName"> {{ $fullname or 'Gatot Kaca' }} </span> <span class="caret"></span></a>
